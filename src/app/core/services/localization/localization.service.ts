...
export class LocalizationService {
  ...
  private localization: {[key: string]: {[key: string]: string}} = {
    [Languages.EN]: {
      ...
      'edit_link': 'Data sheet',
      'edit_link_hint': 'Enter link to data sheet',
    ...
    [Languages.RU]: {
      ...
      'edit_link': 'Техническая спецификация',
      'edit_link_hint': 'Введите ссылку на техническую спецификацию',
